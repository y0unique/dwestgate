...
<html lang="en">
  ...
  <head>
    ...
    <meta name="keywords" content="Informational">
    <meta charset="utf-8">
  ...
  <body class="index-page">
    ...
    <header id="header" class="header d-flex align-items-center fixed-top">
      <div class="container position-relative d-flex align-items-center justify-content-between">
        ...
        <a href="index.php" class="logo d-flex align-items-center me-auto me-xl-0">
          ...
          <h1 class="sitename">Dwestgate</h1>
        </a>
    ...
    <main class="main">
      ...
      <section id="call-to-action" class="call-to-action section dark-background">
        ...
        <img src="assets/img/full-width-images/hero-bg.jpg" alt="">
        ...
        <div class="container">
          ...
          <div class="row" data-aos="zoom-in" data-aos-delay="100">
            <div class="col-xl-9 text-center text-xl-start">
              <h3>Contact Us</h3>
              <p>We strive to stay in communication with our clients. Have a question about our business, or want to see if we match your specific needs? Send us a message, or give us a call. We're always happy to meet new customers!</p>
            </div>
            <div class="col-xl-3 cta-btn-container text-center">
              <a class="cta-btn align-middle" href="#contact">Learn More...</a>
            </div>
          </div>
      ...
      <!-- Partner Section -->
      <section id="partner" class="portfolio section">
          ...
          <div class="isotope-layout" data-default-filter="*" data-layout="masonry" data-sort="original-order">
            ...
            <div class="row gy-4 isotope-container" data-aos="fade-up" data-aos-delay="200">
              ...
              <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-app">
                <img src="assets/img/partners/j_and_t.png" class="img-fluid" alt="">
          ...
          <div class="row gy-4">
            ...
            <div class="col-lg-4">
              ...
              <div class="info-item d-flex" data-aos="fade-up" data-aos-delay="300">
                ...
                <div>
                  <h3>Call Us</h3>
                  <p>09171739910<br>09171897294</p>
                </div>
              </div><!-- End Info Item -->
    ...
    <footer id="footer" class="footer dark-background">
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            <h3 class="sitename">Dwestgate</h3>
            ...
            <div class="social-links d-flex justify-content-center">
              ...
              <a href="mailto:annmercado@dwestgate.ph"><i class="bi bi-envelope-at-fill"></i></a>
            </div>
            <div>
              © <?php echo date("Y"); ?> D WEST GATE <i class="bi bi-arrow-through-heart-fill"></i>
            </div>



            <div class="container">
              <button id="toggleFooter" class="btn" data-bs-toggle="button" 
                  style="--bs-btn-padding-y: .25rem; --bs-btn-padding-x: .5rem; --bs-btn-font-size: .75rem;">
                  Show Credits
              </button>

              <div id="footerContent" style="display: none; margin-top: 10px;">
                  <div class="copyright">
            ...
            <script>
                $(document).ready(function () {
                    $("#toggleFooter").click(function () {
                        $("#footerContent").slideToggle(400, function () {
                            // Change button text based on visibility
                            $("#toggleFooter").text($(this).is(":visible") ? "Hide Credits" : "Show Credits");
                        });
                    });
                });
            </script>
