...
<html lang="en">
    ...
    <body>
        ...
        <!-- Skip to Content -->
        <a href="#main" class="btn skip-to-content">Text</a>
        <!-- End Skip to Content -->
                                ...
                                <div class="home-content container">
                                    <div class="home-text">
                                        ...
                                        <div class="home-call-action animate">
                                            <a href="#about-us" class="btn btn-spacia btn-w btn-large"> Text</a>
                    ...
                    <div class="container bg-content">
                        <div class="row">
                            <div class="col-md-8 col-lg-6 col-lg-offset-2 banner-text">
                                <!-- Text -->
                                <h3 class="banner-heading">Text</h3>
                            ...
                            <div class="col-md-4 col-lg-2 banner-button">
                                <!-- Button -->
                                <a href="#contacts" class="btn btn-spacia btn-w btn-large">Text</a>
                            </div>
                        </div>
                    </div>
                </section>
                    ...
                    <div class="container bg-content">
                        <div class="row">
                            ...
                            <div class="col-md-4 col-lg-2 banner-button">
                                ...
                                <!-- Button -->
                                <a href="#contacts" class="btn btn-spacia btn-w-color btn-large">Text</a>
                            ...
                            <div class="col-md-10 col-md-offset-1 col-lg-10 col-lg-offset-1">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4 col-md-4 col-lg-4 contact-block go-fade-in">
                                        ...
                                        <div class="contact-text">
                                            <!-- Enter your e-mail here -->
                                            <a href="mailto:spacia@lookandfeel.pro">sample@email.com</a>
                                        </div>
